...
import type { EnderecoData, FuncionarioData } from "../../types/funcionario"
...
function CadastroFuncionario() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Nota: O tipo aqui é 'any' para o envio, pois a estrutura muda (endereco vira string)
    // Se quiser tipar estritamente, crie uma interface FuncionarioPayload
