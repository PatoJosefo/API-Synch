...
//Criar evento
async criarEvento(data: CriarEventoDto) {
...
async listarEventos() {
  ...
  async adicionarConvidados(eventoId: number, convidados: ConvidadoDto[]) {
  ...
  //Confirmar presença
  async confirmarPresenca(eventoId: number, data: PresencaDto) {
  ...
  async desmarcarPresenca(eventoId: number, data: PresencaDto) {
  ...
  async criarNotificacao(eventoId: number, data: NotificacaoDto, funcIds: number[]) {
